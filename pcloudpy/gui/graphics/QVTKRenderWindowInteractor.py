...
from vtk import vtkRenderer, vtkRenderWindow, vtkRenderWindowInteractor,vtkGenericRenderWindowInteractor
...
if sys.platform == "win32":
    from ctypes import pythonapi, c_void_p, py_object, c_double, pointer
